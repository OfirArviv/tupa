...
class AlignmentFeatureExtractor:
    ...
    def extract_features(self, state: State):
        ...
        b0_grandparent_tag = AlignmentFeatureExtractor._extract_parent_tag(state, b0, 1)
        ...
        features['a_numeric'] = [s0_depth, b0_depth]
